 ...
 * @author UPJV
 */
public class AjoutQuestion extends javax.swing.JFrame {
    ...
    public AjoutQuestion() {
        ...
        try{
            ...
            ResultSet rs=st.executeQuery("select count(idQ) from question");
            if(rs.first()){
                int id=rs.getInt(1);
                    id=id+1;
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Ajouter unE Question");
        ...
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 310, 97, 30));

        txtrep.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        getContentPane().add(txtrep, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 310, 436, -1));
        ...
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 261, 97, -1));
